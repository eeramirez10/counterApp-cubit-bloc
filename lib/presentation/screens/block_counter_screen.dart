...
class BlocCounterView extends StatelessWidget {
  ...
  void resetCounter(BuildContext contex) {
    contex.read<CounterBloc>().resetCounter();
  }

  @override
  Widget build(BuildContext context) {
    final counterState = context.watch<CounterBloc>();
    return Scaffold(
      appBar: AppBar(
      ...
      body: Center(
        child: Text('Counter value: ${counterState.state.counter}'),
      ),
